                ...
                if body_id != body_excluded and body_id != flybys[-1]["body_id"]:
                    ...
                    for w in range(2):
                        ...
                        for k in range(len(l.get_v1())):
                            ...
                            invalid, _ = shield_state(shield_burned, r1, v1, r2_body_j, v2, tof[i])
                    ...
                    if dv_req < 200:
                        ...
                        if res_dv.fun < dv_min_found and res_dv.x > 0:
                            ...
                            v1, v2, r2_body_j, dv_req, pre_burned_shield = update_lmbrt_params(
                                r1,
                                tof_af_minimize,
                                t,
                                body_j,
...
def get_min_dv_real(
    ...
    MU_ALTAIRA : float
        Gravitational parameter used in the Lambert solver.
    max_revs_lmbrt : int
...
def minimize_lmbrt_dv(tof, t, r1, body_j, vin_fb, vp, max_revs_lmbrt, planet, shield_burned):
    """
...
def update_lmbrt_params(
    r1, tof, t, body_j, vin_fb, max_revs_lmbrt, planet_init, period, n_period, shield_burned):
                        ...
                        if res_f != False and res_f != None:  
                            ...
                            if res_f.fun < res_f_best:
                                ...
                                if res_f_best < 1:
                                    ...
                                    print("Delta with planet position is [m]:", np.array(rf) - np.array(rp))
